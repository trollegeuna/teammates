...
public final class FeedbackSessionsLogic {
    ...
    public List<FeedbackSessionAttributes> getFeedbackSessionsForUserInCourseSkipCheck(String courseId,
        ...
        if (!sessions.isEmpty()) {
            ...
            for (FeedbackSessionAttributes session : sessions) {
                if (FeedbackSessionsLogicChecks.isFeedbackSessionViewableTo(session, userEmail, isInstructorOfCourse)) {
    ...
    public FeedbackSessionDetailsBundle getFeedbackSessionDetails(FeedbackSessionAttributes fsa)
        ...
        case PRIVATE:
            ...
            if (FeedbackSessionsLogicChecks.isFeedbackSessionFullyCompletedByInstructor(fsa.getFeedbackSessionName(),
                    fsa.getCourseId(), fsa.getCreatorEmail())) {
    ...
    private FeedbackSessionResultsBundle getFeedbackSessionResultsForUserInSectionByQuestions(
        ...
        for (FeedbackQuestionAttributes question : allQuestions) {
            ...
            List<FeedbackResponseAttributes> responsesForThisQn = getFeedbackResponsesForThisQn(userEmail, session,
        ...
        if (FeedbackSessionsLogicChecks.isStudent(role)) {
    ...
    private List<FeedbackResponseAttributes> getFeedbackResponsesForThisQn(String userEmail,
            FeedbackSessionAttributes session, FeedbackQuestionAttributes question, UserRole role, String section) {
    ...
    private FeedbackSessionResultsBundle getFeedbackSessionResultsForUserWithParams(String feedbackSessionName,
        ...
        for (FeedbackResponseAttributes response : allResponses) {
            ...
            if (relatedQuestion != null) {
                ...
                boolean isVisibleResponse = FeedbackSessionsLogicChecks.isResponseVisibleForUser(userEmail, role,
                        student, studentsEmailInTeam, response, relatedQuestion, instructor);
    ...
    private Map<String, FeedbackQuestionAttributes> getAllQuestions(UserRole role, Map<String, String> params,
        ...
        if (FeedbackSessionsLogicChecks.isInstructor(role) && !params.containsKey(PARAM_QUESTION_ID)) {
            putQuestionsIntoMap(allQuestions, relevantQuestions);
        }
